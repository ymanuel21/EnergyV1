  ...
  return (
    <form onSubmit={handleSubmit} className="relative w-full max-w-lg">
      ...
      <input
        ...
        className="w-full rounded-lg border border-border py-2 pl-4 pr-12 text-sm focus:border-gray-700 focus:ring-1 focus:ring-gray-700 outline-none transition-colors"
      />
      <button
        type="submit"
